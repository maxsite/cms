...
# получение всех ушек по имени
# если указать разделитель, то возвращает строку, иначе массив
function ushki_get_all_names($delim = false)
{
	$ushki = ushki_get_all();
	$names = array_column($ushki, 'name');
