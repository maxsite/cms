...
<?php
	...
	if ($CI->db->conn_id === FALSE) // нет коннекта к БД
	{
		echo '<h1>' . t('Добро пожаловать в программу установки <a href="http://max-3000.com/">MaxSite CMS</a>!', 'install') . '</h1>';
			
		echo '<div class="wrap">';
		echo '<p class="error">' . t('База данных недоступна. Проверьте параметры доступа к базе MySQL в файле <span>application/config/database.php</span>.', 'install') . '</p>';
		echo '</div>';
