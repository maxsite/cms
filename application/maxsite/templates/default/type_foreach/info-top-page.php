...
/*
	info-top файл для одиночной записи page
*/

$p->format('edit', '<i class="i-edit t-gray600 hover-t-black" title="Edit page"></i>', '<div class="b-right mar10-t">', '</div>');

$p->format('title', '<h1 class="t-gray700 bor-dotted-b bor1 bor-gray400 pad10-b">', '</h1>', !is_type('page'));
...
$p->html('<header class="mar25-b">');
	...
	require('my-template/_next-prev.php');
	
	$p->line('[edit][title]');
	
	$p->div_start('info info-top t-gray600 t90 lh200');
