...
div(layout-center-wrap mar50-tb) || div(layout-wrap t-center)
	...
	<div class="flex flex-wrap-tablet t-gray600">
		...
		div(w23 w48-tablet w100-tablet mar20-b bg-gray200 pad10 t-center hover-bg-gray300 rounded transition-var)
			...
			__(mar20-tb) <a class="button im-check bg-gray600 hover-bg-primary600" href="#">Order now</a>
		/div
		...
		div(w23 w48-tablet w100-tablet mar20-b t-center t-white bg-primary700 hover-bg-primary600 hover-t-white rounded transition-var animation-zoom)
