...
$(function(){
	...
	// скролл вверх
	$("body").append("<div id='to_top' title='Вверх' class='b-hide pos-fixed pos-right10px pos-bottom10px bg-gray600 t-gray100 cursor-pointer i-arrow-up icon-circle bg-op40'></div>");
	$("#to_top").hide();
