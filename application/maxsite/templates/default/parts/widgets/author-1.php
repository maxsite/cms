...
<img class="center mar20-tb circle" src="<?= getinfo('template_url') ?>assets/images/users/w2.jpg" width="" height="" alt="" title="">
...
_ <a class="italic" href="<?= getinfo('siteurl') ?>page/about">Читать дальше...</a>
