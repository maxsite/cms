...
// TODO: разобраться и по возможности убрать
...
// может заменить на $mso_page_current ? разобраться с mso_page_content() mso_get_comments()
// лучше спрятать её в $MSO и получать через getinfo('page_current')
global $page;
