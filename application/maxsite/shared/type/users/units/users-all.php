...
echo NR . '<div class="mso-type-users-all"><div class="mso-page-only"><div class="mso-page-content mso-type-users-all">' . NR;
...
echo NR . '</div></div></div><!-- class="mso-type-users-all" -->' . NR;
