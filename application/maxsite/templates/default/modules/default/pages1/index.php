...
line2 = <div class="w100 flex-grow2 pad10-t h250px-min">
line3 = [title]
line4 = </div>
line5 = <div class="w100 t90 t-gray bor1 bor-gray300 bor-solid-t pad20-t"><i class="fas fa-eye"></i>[view_count] [plur@page_view_count|просмотр|просмотра|просмотров] <span class="b-inline b-right mar10-l"><i class="fas fa-comments"></i>[comments_count] [plur@page_count_comments|комментарий|комментария|комментариев]</span></div>
