...
Для типа textfield и textarea можно указать кавычку (") в виде _QUOT_ - он автоматически пербразуется в &quot; 
Для типа textfield и textarea можно указать пробел в виде _NBSP_ - он автоматически пербразуется в « »; 
